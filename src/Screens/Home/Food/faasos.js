...
class Index extends Component{
  ...
  static navigationOptions = ({ navigation }) => {
    return {
        ...
        headerRight: (
          <Ionicons name="ios-help-circle-outline" size={24} color="#444" style={{padding: 5, marginRight: 10}} onPress={() => WebBrowser.openBrowserAsync('https://linksredirect.com/?pub_id=8447CL7862&source=linkkit&url=https%3A%2F%2Forder.faasos.io%2Fabout')}/>
        ),
    };
  };
    ...
    return (
      <View style={{position: 'absolute', left: 0, right: 0, top: -50, backgroundColor: '#fff', bottom: 20, alignItems: 'center', justifyContent: 'center'}}>
          { this.props.loaded ? (
            ...
            <Thumbnail style={{height: 100, width: 100, borderRadius: 50}} source={require('../../../assets/faasos.png')} />
              <ProgressBarAndroid
       ...
       { this.props.loaded ? (
        ...
        <KeyboardAvoidingView behavior="padding" style={{height: heightView, backgroundColor: '#fff'}} enabled>
          <WebView
            ...
            source={{uri: 'https://linksredirect.com/?pub_id=8447CL7862&source=linkkit&url=https%3A%2F%2Forder.faasos.io%2F'}}
