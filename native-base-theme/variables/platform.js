...
export default {
  ...
  // Color
  brandPrimary: platform === "ios" ? '#5271ff' : "#5271ff",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // FooterTab
  tabBarTextColor: platform === "ios" ? "#777" : "#777",
  tabBarTextSize: platform === "ios" ? 14 : 10,
  activeTab: platform === "ios" ? "#fff" : "#fff",
  sTabBarActiveTextColor: "#5271ff",
  tabBarActiveTextColor: platform === "ios" ? "#5271ff" : "#5271ff",
